...
```bash
git clone https://github.com/gedionzewdu/MERN-Ecommerce.git
```
...
Open [http://localhost:5174](https://www.google.com/search?q=http://localhost:5174) in your browser to view the admin dashboard.

Open [http://localhost:400](https://www.google.com/search?q=http://localhost:400) in your browser to run the backend.

Open [http://localhost:5173](https://www.google.com/search?q=http://localhost:5173) in your browser to view the frontend project.